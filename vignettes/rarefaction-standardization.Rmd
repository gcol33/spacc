...
`rarefy()` accepts any non-negative order `q`. Orders 0, 1, and 2 use
exact estimators (Hurlbert's expectation for richness, with the
corresponding Shannon and Simpson forms); other orders report the Hill
number of order `q`:
