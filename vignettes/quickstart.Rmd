...
To accumulate sites in a sequence you control, pass `order`: a permutation
of site indices, or a matrix with one ordering per row to get confidence
bounds across orderings. This bypasses the distance-based methods and
accumulates sites in exactly the order given:
