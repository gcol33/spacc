...
`spacc` automatically selects the fastest backend for nearest-neighbor
queries:
...
Override with `backend = "kdtree"` or `backend = "exact"`. The ball tree
uses haversine distance natively — no coordinate projection needed for
geographic data.
...
- **[`spaccBeta()`](https://gillescolling.com/spacc/reference/spaccBeta.md)**:
  Beta diversity with turnover/nestedness partitioning (Baselga 2010)
...
- **[`spaccMetrics()`](https://gillescolling.com/spacc/reference/spaccMetrics.md)**:
  Per-site accumulation metrics (slope, AUC, half-richness)

All diversity and accumulation functions support spatial mapping via
`map = TRUE`, `plot(x, type = "map")`, and
[`as_sf()`](https://gillescolling.com/spacc/reference/as_sf.md) for
sf/GIS integration.

### Analysis

- **[`extrapolate()`](https://gillescolling.com/spacc/reference/extrapolate.md)**:
  Fit asymptotic models (5 options)
...
- **[`rarefy()`](https://gillescolling.com/spacc/reference/rarefy.md)**:
  Rarefaction to common sampling effort
- **[`subsample()`](https://gillescolling.com/spacc/reference/subsample.md)**:
  Spatial subsampling of sites
- **[`coleman()`](https://gillescolling.com/spacc/reference/coleman.md)**,
  ...
  **[`spatialRarefaction()`](https://gillescolling.com/spacc/reference/spatialRarefaction.md)**:
  Analytical (non-simulation) methods
