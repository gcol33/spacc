...
cpp_knn_coverage_single <- function(species_mat, dist_mat, seed, coverage_type = 0L) {
    .Call(`_spacc_cpp_knn_coverage_single`, species_mat, dist_mat, seed, coverage_type)
}

cpp_knn_coverage_parallel <- function(species_mat, dist_mat, n_seeds, n_cores = 1L, progress = FALSE, coverage_type = 0L) {
    .Call(`_spacc_cpp_knn_coverage_parallel`, species_mat, dist_mat, n_seeds, n_cores, progress, coverage_type)
}
...
cpp_knn_hill_beta_parallel <- function(species_mat, dist_mat, n_seeds, q_values, n_cores = 1L, progress = FALSE) {
    .Call(`_spacc_cpp_knn_hill_beta_parallel`, species_mat, dist_mat, n_seeds, q_values, n_cores, progress)
}

cpp_knn_hill_coverage_parallel <- function(species_mat, dist_mat, n_seeds, q_values, n_cores = 1L, progress = FALSE) {
    .Call(`_spacc_cpp_knn_hill_coverage_parallel`, species_mat, dist_mat, n_seeds, q_values, n_cores, progress)
}
