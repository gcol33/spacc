...
cpp_beta_order_single <- function(species_pa, dist_mat, order, use_jaccard = FALSE) {
    .Call(`_spacc_cpp_beta_order_single`, species_pa, dist_mat, order, use_jaccard)
}

cpp_beta_order_parallel <- function(species_pa, dist_mat, orders, use_jaccard = FALSE, n_cores = 1L, progress = FALSE) {
    .Call(`_spacc_cpp_beta_order_parallel`, species_pa, dist_mat, orders, use_jaccard, n_cores, progress)
}
...
calc_chiu_coverage <- function(abundances, incidences, T_sites) {
    .Call(`_spacc_calc_chiu_coverage`, abundances, incidences, T_sites)
}

cpp_order_coverage_single <- function(species_mat, order, coverage_type = 0L) {
    .Call(`_spacc_cpp_order_coverage_single`, species_mat, order, coverage_type)
}

cpp_order_coverage_parallel <- function(species_mat, orders, n_cores = 1L, progress = FALSE, coverage_type = 0L) {
    .Call(`_spacc_cpp_order_coverage_parallel`, species_mat, orders, n_cores, progress, coverage_type)
}
...
cpp_order_hill_single <- function(species_mat, order, q_values) {
    .Call(`_spacc_cpp_order_hill_single`, species_mat, order, q_values)
}

cpp_order_hill_parallel <- function(species_mat, orders, q_values, n_cores = 1L, progress = FALSE) {
    .Call(`_spacc_cpp_order_hill_parallel`, species_mat, orders, q_values, n_cores, progress)
}

cpp_order_hill_beta_parallel <- function(species_mat, orders, q_values, n_cores = 1L, progress = FALSE) {
    .Call(`_spacc_cpp_order_hill_beta_parallel`, species_mat, orders, q_values, n_cores, progress)
}

cpp_order_hill_coverage_parallel <- function(species_mat, orders, q_values, n_cores = 1L, progress = FALSE) {
    .Call(`_spacc_cpp_order_hill_coverage_parallel`, species_mat, orders, q_values, n_cores, progress)
}
...
cpp_nn_walk_single <- function(species_pa, dist_mat, seed) {
    .Call(`_spacc_cpp_nn_walk_single`, species_pa, dist_mat, seed)
}

cpp_nn_walk_parallel <- function(species_pa, dist_mat, n_seeds, n_cores = 1L, progress = FALSE) {
    .Call(`_spacc_cpp_nn_walk_parallel`, species_pa, dist_mat, n_seeds, n_cores, progress)
}

cpp_nn_walk_parallel_seeds <- function(species_pa, dist_mat, seeds, n_cores = 1L, progress = FALSE) {
    .Call(`_spacc_cpp_nn_walk_parallel_seeds`, species_pa, dist_mat, seeds, n_cores, progress)
}

cpp_nn_walk_kdtree_single <- function(species_pa, x, y, seed, distance = "euclidean") {
    .Call(`_spacc_cpp_nn_walk_kdtree_single`, species_pa, x, y, seed, distance)
}

cpp_nn_walk_kdtree_parallel <- function(species_pa, x, y, n_seeds, n_cores = 1L, progress = FALSE, distance = "euclidean") {
    .Call(`_spacc_cpp_nn_walk_kdtree_parallel`, species_pa, x, y, n_seeds, n_cores, progress, distance)
}

cpp_nn_walk_kdtree_parallel_seeds <- function(species_pa, x, y, seeds, n_cores = 1L, progress = FALSE, distance = "euclidean") {
    .Call(`_spacc_cpp_nn_walk_kdtree_parallel_seeds`, species_pa, x, y, seeds, n_cores, progress, distance)
}
...
cpp_nn_walk_metrics_parallel <- function(species_pa, dist_mat, n_cores = 1L, progress = FALSE) {
    .Call(`_spacc_cpp_nn_walk_metrics_parallel`, species_pa, dist_mat, n_cores, progress)
}
...
cpp_nn_walk_order <- function(dist_mat, seeds) {
    .Call(`_spacc_cpp_nn_walk_order`, dist_mat, seeds)
}

cpp_focal_order <- function(x, y, focus_x, focus_y, distance = "euclidean") {
    .Call(`_spacc_cpp_focal_order`, x, y, focus_x, focus_y, distance)
}
...
cpp_phylo_order_single <- function(species_pa, order, phylo_dist_mat, metrics, tree_edge = NULL, tree_edge_length = NULL, tree_n_tips = 0L) {
    .Call(`_spacc_cpp_phylo_order_single`, species_pa, order, phylo_dist_mat, metrics, tree_edge, tree_edge_length, tree_n_tips)
}

cpp_phylo_order_parallel <- function(species_pa, orders, phylo_dist_mat, metrics, n_cores = 1L, progress = FALSE, tree_edge = NULL, tree_edge_length = NULL, tree_n_tips = 0L) {
    .Call(`_spacc_cpp_phylo_order_parallel`, species_pa, orders, phylo_dist_mat, metrics, n_cores, progress, tree_edge, tree_edge_length, tree_n_tips)
}
...
cpp_func_order_single <- function(species_mat, order, traits, metrics) {
    .Call(`_spacc_cpp_func_order_single`, species_mat, order, traits, metrics)
}

cpp_func_order_parallel <- function(species_mat, orders, traits, metrics, n_cores = 1L, progress = FALSE) {
    .Call(`_spacc_cpp_func_order_parallel`, species_mat, orders, traits, metrics, n_cores, progress)
}
